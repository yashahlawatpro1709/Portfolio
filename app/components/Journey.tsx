...
export default function Journey() {
  ...
  <li>
    ...
    <div className="timeline-start md:text-end mb-10">
      <time className="font-mono italic">August-2020</time>
      <div className="text-lg font-black">Srm E-hub</div>
      I started off as a web intern to work with my college club that promoted entreprenurship and i began implementing various designs using the basic web tech stack that includes HTML,CSS,JS and i build their collaborator platform
    </div>
    <hr/>
  </li>
  <li>
